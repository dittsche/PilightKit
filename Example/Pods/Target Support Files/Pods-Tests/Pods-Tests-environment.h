...
// PilightKit
#define COCOAPODS_POD_AVAILABLE_PilightKit
#define COCOAPODS_VERSION_MAJOR_PilightKit 0
#define COCOAPODS_VERSION_MINOR_PilightKit 1
#define COCOAPODS_VERSION_PATCH_PilightKit 0
